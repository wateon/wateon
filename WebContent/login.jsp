...
<body>
	...
	<form name="Login" action="login.do" method="post">
		...
		<input id="id" name="id" type="text" size="25" value="wateon@nate.com" onfocus="deleteValue('id')">
		<br />
		
		<label for="password">비밀번호 : </label>
		<input id="password" name="password" type="password" size="27" value="dnpdlxmdhs" onfocus="deleteValue('password')">
		<br />
